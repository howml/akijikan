...
var getOpenDataCivicFacility = function(lat, lng, dll, callback) {
	getOpenDataByArea("http://purl.org/jrrk#CivicFacility", lat, lng, dll, callback);
};
var getOpenDataPOI = function(lat, lng, dll, callback) {
	getOpenDataByArea("http://purl.org/jrrk#CivicPOI", lat, lng, dll, callback);
};
var getOpenDataByArea = function(type, lat, lng, dll, callback) {
	var latmin = lat - dll;
	var latmax = lat + dll;
	var lngmin = lng - dll;
	var lngmax = lng + dll;
